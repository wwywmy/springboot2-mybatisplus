...
public class HttpClient {
	...
	public String doGet(String url, Map<String, Object> requestParameter, Map<String, Object> headerParameter) throws Exception {
		URIBuilder uriBuilder = new URIBuilder(url);
		...
		if (headerParameter != null) {
			headerParameter.keySet().forEach(x -> {
				httpGet.addHeader(x, headerParameter.get(x).toString());
			});
		}
	...
	public HttpResponse doPost(String url, Map<String, Object> requestParameter, Map<String, Object> headerParameter) throws Exception {
		...
		if (headerParameter != null) {
			headerParameter.keySet().forEach(x -> {
				httpPost.addHeader(x, headerParameter.get(x).toString());
			});
		}
